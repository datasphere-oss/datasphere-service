import * as React from 'react';
    ...
    +     return (
    +         <div className=\"modal modal3\" ng-controller=\"NewDatamodelModalController\">
    +             <DkuModalHeader modal-class=\"has-border\">
    +                 <DkuModalTitle>
    +                     {uiState.step == 'choose-type' ? <span>新建数据模型</span> : null}
    +                     {uiState.step == 'sql' ? <span>新建维度逻辑表</span> : null}
    +                     {uiState.step == 'impala' ? <span>新建逻辑模型</span> : null}
    +                     {uiState.step == 'hive' ? <span>新建事实表</span> : null}
    +                     {uiState.step == 'python' ? <span>新建维度表</span> : null}
    ...
    +                                                             ) : null}
    +                                                             <div className=\"control-group\">
    +                                                                 <label className=\"control-label\">维度逻辑表名称</label>
    +                                                                 <div className=\"controls\">
    +                                                                     <input
    +                                                                         name=\"datasetName\"
