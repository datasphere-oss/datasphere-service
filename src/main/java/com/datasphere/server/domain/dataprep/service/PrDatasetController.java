...
public class PrDatasetController {
    ...
    public ResponseEntity<?> getDataset(
        ...
        try {
            dataset = this.datasetRepository.findById(dsId).get();
            if(dataset!=null) {
                if(true == preview) {
    ...
    public ResponseEntity<?> deleteDataset(
        ...
        try {
            PrDataset dataset =  this.datasetRepository.findById(dsId).get();
            if(dataset!=null) {
    ...
    */
    ...
    public @ResponseBody ResponseEntity<?> file_upload(
        ...
        try {
            ...
            PrUploadFile uploadFile = this.uploadFileRepository.findById(upload_id).get();
            if(uploadFile==null) {
