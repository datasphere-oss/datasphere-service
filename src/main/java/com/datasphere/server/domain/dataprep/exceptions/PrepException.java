...
import com.datasphere.server.domain.dataprep.teddy.exceptions.ColumnNotFoundException;
import com.datasphere.server.domain.dataprep.teddy.exceptions.ColumnTypeShouldBeDoubleOrLongException;
import com.datasphere.server.domain.dataprep.teddy.exceptions.GroupByColumnNotFoundException;
import com.datasphere.server.domain.dataprep.teddy.exceptions.IdxOnMapTypeShouldBeStringException;
import com.datasphere.server.domain.dataprep.teddy.exceptions.IllegalAggregationFunctionExpression;
...
import com.datasphere.server.domain.dataprep.teddy.exceptions.InvalidDeltaValueException;
import com.datasphere.server.domain.dataprep.teddy.exceptions.InvalidFunctionArgsException;
import com.datasphere.server.domain.dataprep.teddy.exceptions.InvalidFunctionTypeException;
import com.datasphere.server.domain.dataprep.teddy.exceptions.InvalidIndexTypeException;
import com.datasphere.server.domain.dataprep.teddy.exceptions.InvalidJoinTypeException;
import com.datasphere.server.domain.dataprep.teddy.exceptions.InvalidJsonException;
import com.datasphere.server.domain.dataprep.teddy.exceptions.InvalidTimestampUnitException;
import com.datasphere.server.domain.dataprep.teddy.exceptions.InvalidTimezoneIDException;
...
import com.datasphere.server.domain.dataprep.teddy.exceptions.NeedBeforeOrAfterException;
import com.datasphere.server.domain.dataprep.teddy.exceptions.NoAssignmentStatementIsAllowedException;
import com.datasphere.server.domain.dataprep.teddy.exceptions.NoInputColumnDesignatedException;
import com.datasphere.server.domain.dataprep.teddy.exceptions.NoLimitException;
...
import com.datasphere.server.domain.dataprep.teddy.exceptions.RuleNotSupportedException;
import com.datasphere.server.domain.dataprep.teddy.exceptions.TargetColumnNotFoundException;
import com.datasphere.server.domain.dataprep.teddy.exceptions.TeddyException;
import com.datasphere.server.domain.dataprep.teddy.exceptions.TimestampFormatMismatchException;
import com.datasphere.server.domain.dataprep.teddy.exceptions.TooManyPivotedColumnsException;
...
import com.datasphere.server.domain.dataprep.teddy.exceptions.TypeDifferentException;
import com.datasphere.server.domain.dataprep.teddy.exceptions.TypeMismatchException;
...
import com.datasphere.server.domain.dataprep.teddy.exceptions.UnsupportedAggregationFunctionExpressionException;
import com.datasphere.server.domain.dataprep.teddy.exceptions.UnsupportedConstantType;
import com.datasphere.server.domain.dataprep.teddy.exceptions.WorksOnlyOnArrayException;
import com.datasphere.server.domain.dataprep.teddy.exceptions.WorksOnlyOnArrayOrMapException;
import com.datasphere.server.domain.dataprep.teddy.exceptions.WorksOnlyOnNumericException;
import com.datasphere.server.domain.dataprep.teddy.exceptions.WorksOnlyOnStringException;
import com.datasphere.server.domain.dataprep.teddy.exceptions.WorksOnlyOnTimestampException;
import com.datasphere.server.domain.dataprep.teddy.exceptions.WrongAggregationFunctionExpressionException;
import com.datasphere.server.domain.dataprep.teddy.exceptions.WrongArrayIndexException;
import com.datasphere.server.domain.dataprep.teddy.exceptions.WrongGroupEveryCountException;
import com.datasphere.server.domain.dataprep.teddy.exceptions.WrongMapKeyException;
import com.datasphere.server.domain.dataprep.teddy.exceptions.WrongSubstringIndexParamException;
import com.datasphere.server.domain.dataprep.teddy.exceptions.WrongTargetColumnExpressionException;
import com.datasphere.server.domain.dataprep.teddy.exceptions.WrongTargetPositionException;
